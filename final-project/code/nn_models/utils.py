...
def process_data(df):
    """
    Processes the data before the train/test split. We drop the target from the huge list of column.
    At this stage all columns are merged. We drop the columns that are not useful for the model.
    """
