...
% There is no section on analysis of K folds
...
There's a good amount of stuff still open to further discussion and testing, including the use of Max Pooling to do dimension reduction, number of channels for the convolution layers and the kernel size. 
